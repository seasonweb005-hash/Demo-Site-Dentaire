	...
	*/
	protected function render() {
		...
		ob_start();
		 ...
		 ?>
<div class="swiper-container namep-swiper-slide swiper-slides swiper-keyboard" data-loop="<?php echo esc_attr($carousel_loop); ?>" data-autoplay="<?php echo esc_attr($carousel_autoplay); ?>" data-effect="<?php echo esc_attr($carousel_effect); ?>" data-speed="<?php echo esc_attr($carousel_speed); ?>" data-clickpage="<?php echo esc_attr($clickable_pagi); ?>" data-mousedrag="<?php echo esc_attr($carousel_mousedrag); ?>"  data-swiper="container">
